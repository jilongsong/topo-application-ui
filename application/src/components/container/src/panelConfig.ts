...
import { baseStyleConfig, borderStyleConfig, boxShadowStyleConfig } from '../../../configs';

import { MContainer } from './type';

const property: PanelConfig<MContainer['property']> = {
  fields: {
    disabled: {
...
const style: PanelConfig<MContainer['style']> = {
  fields: {
    ...baseStyleConfig(),
    background: {
...
const event = (services: Services): PanelConfig<MContainer['event']> => {
  return {
    fields: {
      onClick: {
