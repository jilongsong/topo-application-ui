...
export const CONTAINER_HIGHLIGHT_CLASS = 'topo-stage-container-highlight';

export const PAGE_CLASS = 'topo-ui-page';
...
/** 选中节点的class name */
export const SELECTED_CLASS = 'topo-stage-selected-area';
