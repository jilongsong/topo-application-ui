<template>
  <div ref="bar" class="topo-editor-scroll-bar" :class="isHorizontal ? 'horizontal' : 'vertical'">
    <div ref="thumb" class="topo-editor-scroll-bar-thumb" :style="thumbStyle"></div>
  </div>
</template>
...
<style lang="scss">
.topo-editor-scroll-bar {
  position: absolute;
  background-color: transparent;
  opacity: 0.3;
  transition: background-color 0.2s linear, opacity 0.2s linear;

  .topo-editor-scroll-bar-thumb {
