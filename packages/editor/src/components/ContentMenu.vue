<template>
  <div
    ...
    ref="menu"
    class="fixed min-w-32 max-h-96 overflow-y-scroll z-50 overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-80"
    :style="menuStyle"
  >
    <div>
      <ToolButton
